...
<!-- Stylesheets -->
<link href="themes/webpage/css/bootstrap.min.css" rel="stylesheet">

<link href="themes/webpage/plugins/revolution/css/settings.css" rel="stylesheet" type="text/css"><!-- REVOLUTION SETTINGS STYLES -->
<link href="themes/webpage/plugins/revolution/css/layers.css" rel="stylesheet" type="text/css"><!-- REVOLUTION LAYERS STYLES -->
...
<link rel="shortcut icon" href="themes/webpage/images/favicon.png" type="image/x-icon">
<link rel="icon" href="themes/webpage/images/favicon.png" type="image/x-icon">
			...
			<div class="nav-outer">
				...
				<div class="outer-box">
					<a href="tel:+92(8800)9806" class="info-btn">
						...
						<small>Llamanos al:</small><br> +92 (8800) - 8960
					</a>
					...
					<a href="page-contact.php" class="theme-btn btn-style-one"><span class="btn-title">Campus Virtual</span></a>
				...
				<ul class="contact-list-one">
					...
					<li>
						...
						<div class="contact-info-box">
							...
							<a href="/cdn-cgi/l/email-protection#b5ddd0d9c5f5d6dad8c5d4dbcc9bd6dad8"><span class="__cf_email__" data-cfemail="4028252c3000232f2d30212e396e232f2d">[email&#160;protected]</span></a>
						</div>
					</li>
					<li>
						<!-- Contact Info Box -->
        ...
        <div class="row">
            ...
            <div class="image-column col-lg-6 col-md-12">
                ...
                <div class="inner-column wow fadeInLeft">
                    <figure class="image-1 overlay-anim wow fadeInUp"><img src="{{ asset('themes/webpage/images/resource/about-1.png') }}" alt=""></figure>
                    <figure class="image-2 overlay-anim wow fadeInRight"><img src="{{ asset('themes/webpage/images/resource/about-2.jpg') }}" alt=""></figure>
                ...
                <div class="course-block">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            ...
                            <h5 class="title" style="margin-bottom: 10px;">
...
<script src="themes/webpage/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="themes/webpage/plugins/revolution/js/extensions/revolution.extension.video.min.js"></script>
<script src="themes/webpage/js/main-slider-script.js"></script>
<!--Revolution Slider-->

<script src="themes/webpage/js/bootstrap.min.js"></script>
<script src="themes/webpage/js/jquery.fancybox.js"></script>
<script src="themes/webpage/js/jquery-ui.js"></script>
<script src="themes/webpage/js/wow.js"></script>
<script src="themes/webpage/js/bxslider.js"></script>
<script src="themes/webpage/js/appear.js"></script>
<script src="themes/webpage/js/mixitup.js"></script>
<script src="themes/webpage/js/jquery.countdown.js"></script>
<script src="themes/webpage/js/select2.min.js"></script>
<script src="themes/webpage/js/swiper.min.js"></script>
<script src="themes/webpage/js/owl.js"></script>
<script src="themes/webpage/js/script.js"></script>
</body>
</html>