...
<body>
    ...
    <div class="container">
        ...
        <p>
            <b>Atentamente,</b><br>
            Equipo de CPROD - Capacitación Profesional Deportiva
        </p>
        <p style="text-align: center; font-size: 14px;">
            CPROD - Capacitación Profesional Deportiva, Domus Hogares Sector 6 mz A lote 1., Distrito de Lince, Provincia de Lima, Perú, +51 907748496
        </p>
        <br>
        <footer>
