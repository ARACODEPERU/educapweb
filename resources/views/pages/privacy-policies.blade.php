...
@section('content')
    ...
    <!-- Start main-content -->
    <x-page-header-privacy-policies />
    <!-- end main-content -->

    <section>
        <div class="container">
            <div class="row">
                <h3 class="title">Última actualización: 09/08/2025</h3>
                            <p class="mt-20 wow fade-in-bottom" data-wow-delay="500ms">
                                En <b> CAPACITACIÓN PROFESIONAL DEPORTIVA - CPROD </b> (en adelante, "nosotros", "nuestro" o "la empresa"), valoramos tu
                                privacidad y
                                ...
                                través de nuestro sitio web <b>https://cprod.com/</b>
                            </p>
                            <br>
                            ...
                            <p class="mt-20 wow fade-in-bottom" data-wow-delay="500ms">
                                ...
                                puedes contactarnos a través de <b>contacto@estudiohorizonte.org</b> o nuestra sede en <b>
                                Domus Hogares Sector 6 mz A lote 1, Chimbote.</b>
                            </p>
            </div>
        </div>
    </section>
